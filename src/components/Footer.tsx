      ...
      <div className="container mx-auto px-6 py-16">
        ...
        >
          ...
          <div className="flex space-x-6 text-sm">
            <Link to="/privacy-policy" className="text-muted-foreground hover:text-accent transition-colors hover:scale-[1.02] inline-block transform-gpu">
              Політика конфіденційності
            </Link>
            <Link to="/terms-of-service" className="text-muted-foreground hover:text-accent transition-colors hover:scale-[1.02] inline-block transform-gpu">
              Умови використання
            </Link>
          </div>
        </motion.div>
